...
plfr_lme4_log = fitlme(grdata(grdata.Weight == 250,:),'log_PLFR ~ sfc_centered + (1+sfc_centered|SubjectID) + (1|Trial)');
                ...
                comp_pgfr = compare(plfr_lme1_log,plfr_lme2_log,'nsim',100);
                comp_pgfr1 = compare(plfr_lme2_log,plfr_lme3_log,'nsim',100);
                comp_pgfr2 = compare(plfr_lme3_log,plfr_lme4_log,'nsim',100);
...
xlabel(han2,'Log Static friction coefficient','FontSize',20);
